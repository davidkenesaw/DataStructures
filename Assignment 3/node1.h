...
//		Postcondition: prints the linked list to the console
//	void printList(const node *head);
//		Precondition: list is const
//		Postcondition: prints the linked list to the console
//	void add(node** head_ref, int new_data);
//		Postcondition: adds an element to the linked list at the end
//	int get(node* n1, int position);
//		Postcondition:gets the element at a specific index of a linked list
//
...
//		void sort_list(node** Linkedlist);
//			precondition:list cant be empty
//			Precondition: sorts the list from least to greatest
//		void split_list(node** list,node** list2, int value);
//			precondition:list cant be empty
//			Precondition: splits the list into two based off what the user specifies
//		void delete_reps(struct node* start,node** copy);
//			precondition:list cant be empty
//			Precondition: deletes all repeated values in a linked list and coppies it to another list preserving the original
//
//
//
//
